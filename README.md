...
The github repository contains the recent version of HAPTRACE (0.1.2). You can install the development version of HAPTRACE from [GitHub](https://github.com/) with:
